...
That layered structure explains why ``all Christians generally'' is insufficient. If the phrase only meant a broad later audience, it would not explain the relation between the plural servants and John the servant. It would not explain why showing and signifying are directed to servants before verse 3 introduces reading, hearing, and keeping. It would not explain why the term carries a master-servant frame at the exact point where God is acting as the one who gives, shows, signifies, and sends.
