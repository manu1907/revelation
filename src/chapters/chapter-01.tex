...
The first word of the book of Revelation has already taught readers too much too quickly. In English, ``The revelation of Jesus Christ'' sounds familiar, settled, almost title-like.\footnote{For a public representative of this title-summary framing, see Tabb's discussion of the opening phrase in the section ``Invitation to Revelation.'' \autocite{tabbTgcRevelation}.} But in Greek the phrase is not a title printed on a cover. It is the beginning of a compressed sentence, and the decisions made there determine who gives, who receives, who shows, who signifies, who serves, what must happen, and when.
